...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Author': ['pasv'],
            'Description': ('This module will continuously check running processes for '
                            'the presence of suspicious users, members of groups, process '
                            'names and finally for any processes running off of USB drives.'),

            'Background' : True,
            # True if we're saving the output as a file
            'SaveOutput' : True,
            # True if the module needs admin rights to run (for most things..)
            'NeedsAdmin' : True,
